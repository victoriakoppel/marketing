...
ROWS = [
    ...
    ("M_PROMO_6","Marcom","Промо / Контент","Сотрудник","Promo · Аяулым","Иманбаева Аяулым Маратовна",1000162,"",""),
    ("M_SMM_1","Marcom","SMM","Сотрудник","Head of SMM · Мария","Коренькова Мария Николаевна",1625032,"",""),
    ("M_SMM_2","Marcom","SMM","Сотрудник","SMM Original","Шафкат Дария",741193,"",""),
    ("M_SMM_3","Marcom","SMM","Сотрудник","SMM Gen","Жандильдина Сабина Канатовна",814000,"",""),
    ("M_SMM_4","Marcom","SMM","Сотрудник","SMM Sport","Шакрат Темірлан Талғатұлы",867456,"макс.",""),
    ("M_SMM_5","Marcom","SMM","Сотрудник","SMM Original","Кулбаева Салтанат Фархатқызы",867456,"макс.",""),
    ...
    ("P_PROD","Продакшн","Продакшн","Суб-лид","Senior production · Александр Е","Александр Е",1291685,"",""),
    ("P_ART_1","Продакшн","Арт","Сотрудник","Graph","Ахметова Раушан Нұрланқызы",815000,"",""),
    ("P_ART_2","Продакшн","Арт","Сотрудник","Graph","Ли Яна Вячеславовна",940000,"макс.",""),
    ("P_ART_3","Продакшн","Арт","Сотрудник","Graph Спорт","Аркениязов Ильяс Юлдашевич",678061,"",""),
    ("P_ART_4","Продакшн","Арт","Сотрудник","Graph","Граф дизайнер",940000,"макс.",""),
    ("P_ART_5","Продакшн","Арт","Сотрудник","Motion","Мкпо Майкл Жозеф",877000,"",""),
    ("P_PROD_1","Продакшн","Продакшн","Сотрудник","Мобилограф / монтажёр","Асанов Әділ Асанұлы",1000162,"",""),
    ("P_PROD_2","Продакшн","Продакшн","Сотрудник","Мобилограф / монтажёр","Шаймардан Мағжан Адилұлы",751000,"",""),
    ("P_PROD_3","Продакшн","Продакшн","Сотрудник","Мобилограф / монтажёр","Жұмағали Әділжан Бауыржанұлы",804324,"",""),
    ("P_PROD_4","Продакшн","Продакшн","Сотрудник","Мобилограф / монтажёр Sport","Жанабеков Кудайберген Канатович",1498769,"",""),
    # Проджект
