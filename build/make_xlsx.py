...
ROWS = [
    ...
    ("P_PROD_1","Продакшн","Продакшн","Сотрудник","Мобилограф / монтажёр","Асанов Әділ · Originals",1000162,"",""),
    ("P_PROD_2","Продакшн","Продакшн","Сотрудник","Мобилограф / монтажёр","Шаймардан Мағжан · Originals",751000,"",""),
    ("P_PROD_3","Продакшн","Продакшн","Сотрудник","Мобилограф / монтажёр","Жұмағали Әділжан · Sport",804324,"",""),
    # Проджект
